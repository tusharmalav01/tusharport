...
const Navv = ({darkMode, toggleDarkMode}) => {
    ...
    const lightColors={
        ...
        button: 'fromm-orange-500 to-amber-500', 
    };
    const darkColors={
        ...
        className={`flex items-center justify-center ${colors.navBg} backdrop-blur-lg rounded-2xl px-4 lg:px-8 py-2 shadow-lg`}>
            <div className=" flex items-center justify-between w-full space-x-6 lg:space-x-8">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    whileHover={{ scale:1.05}}
                    whileTap={{scale :0.95}}
                    className={`lg:block hidden px-6 py-2 font-semibold rounded-full bg-linear-to-r ${colors.button} text-white shadow-md hover:shadow-lg transition-shadow`}>
                        Hire Me
                    </motion.a>
                </div>
                {/* mobile menu button */}
                        ...
                        {navItems.map((item)=>(
                            ...
                            className="block">
                                ...
                                className={`py-3 px-4 rounded-lg text-center ${
                                    ...
                                    <span className={`font-medium ${activeSection === item.name.toLocaleLowerCase()
                                        ?colors.textActive
